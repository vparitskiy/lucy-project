...
while getopts ":c:" opt; do
  case $opt in
    c)
	  ...
	  rm -rf en-ja
	  if [ -f $BASE/data/corpus/reuters-ja-en.txt.gz ]; then
        ...
        wikimatrix)
          ...
          mv WikiMatrix.v1.en-ja.langid.tsv.gz $BASE/data/corpus/wikimatrix-en-ja.tsv.gz
	  if [ -f $BASE/data/corpus/wikimatrix-en-ja.tsv.gz ]; then
    		echo "Data successfully downloaded."
	  else
    		echo "Data not successfully downloaded."
    	  exit
        ...
        kyoto)
          ...
          mv kftt-data-1.0.tar.gz $BASE/data/corpus/kyoto-en-ja.tar.gz
          rm -rf kftt-data-1.0
	  if [ -f $BASE/data/corpus/kyoto-en-ja.tar.gz ]; then
    		echo "Data successfully downloaded."
	  else
    		echo "Data not successfully downloaded."
    	  exit
        ...
        newscommentary)
          ...
          mv news-commentary-v15.en-ja.tsv.gz $BASE/data/corpus/corpus/newscommentary-en-ja.tsv.gz
	  if [ -f $BASE/data/corpus/corpus/newscommentary-en-ja.tsv.gz ]; then
    		echo "Data successfully downloaded."
	  else
    		echo "Data not successfully downloaded."
    	  exit
        ...
        wikititles)
          ...
          mv wikititles-v2.ja-en.tsv.gz $BASE/data/corpus/wikititles-ja-en.tsv.gz
	  if [ -f $BASE/data/corpus/wikititles-ja-en.tsv.gz ]; then
    		echo "Data successfully downloaded."
	  else
    		echo "Data not successfully downloaded."
    	  exit
        ...
        subtitles)
          ...
          mv raw.tar.gz $BASE/data/corpus/subtitles-en-ja.tar.gz
	  if [ -f $BASE/data/corpus/subtitles-en-ja.tar.gz ]; then
    		echo "Data successfully downloaded."
	  else
    		echo "Data not successfully downloaded."
    	  exit
        ...
        paracrawl)
          ...
          mv en-ja.tar.gz $BASE/data/corpus/paracrawl-en-ja.tar.gz
	  rm -rf en-ja.tar.gz
	  if [ -f $BASE/data/corpus/paracrawl-en-ja.tar.gz ]; then
    		echo "Data successfully downloaded."
	  else
    		echo "Data not successfully downloaded."
    	  exit
