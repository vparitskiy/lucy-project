...
parser.add_argument("--in_dir", type=str, required=True, help="directory of kftt files")
parser.add_argument("--type", type=str, help="orig or tok files", default="orig")
parser.add_argument(
    "--out_dir", type=str, required=True, help="directory of concatenated data"
)
parser.add_argument(
...
if __name__ == "__main__":
    ...
    for corpus in corpora:
        for lang in langs:
            with open(
                args.out_dir + "/kftt." + lang, "at", encoding=args.encoding
            ) as outfile:
                with open(
                    os.path.join(args.in_dir + "/" + args.type, corpus + "." + lang),
                    "rt",
