...
parser.add_argument(
    "--enja", type=str, required=True, help="zipped file of en-ja bitext"
)
parser.add_argument(
    "--jaen", type=str, required=True, help="zipped file of ja-en bitext"
)
parser.add_argument(
    "--out_dir", type=str, required=True, help="directory of the unzipped data"
)
parser.add_argument(
